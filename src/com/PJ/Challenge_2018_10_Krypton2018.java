...
public class Challenge_2018_10_Krypton2018 {
        ...
        for (int row=0; row<size; row++) {
            for (int column = 0; column < size; column++) {
                ...
                if (row == 0 & column == 0) {
                    ...
                    int rightCandidateResult = Math.min(
                            rightCandidate[0] + currentElement[0],
                            rightCandidate[1] + currentElement[1]);

                    int downCandidateResult = Math.min(
                            downCandidate[0] + currentElement[0],
                            downCandidate[1] + currentElement[1]);
    ...
    private static int[] dividableByTwoAndFive(int value) {
